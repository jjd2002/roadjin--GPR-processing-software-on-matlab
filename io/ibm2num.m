...
%
% IBM2NUM: Convert IBM 32 bit floating point format to IEEE 754 doubles
%          (MATLAB standard)
%
% Usage :  x = num2ibm(b)
%
% Input :
%     b :  A matrix of uint32 numbers (IBM Floating point eqv)
%
%Output :
%     x :  A corresponding to "b" matrix of IEEE doubles
%
%  Note : See also num2ibm
% 
